            ...
            <div className="sample-page-parent bg-img-cover parent">
              <div className="sample-page-cont ">
                <div className="sample-page-right  ">
                  <h2>{data.Marathwada_coach_factory_heading}</h2>
                </div>
                <div className="sample-page-left bg-img-contain"></div>
              </div>
            </div>
            ...
            <div className="sample-page-parent bg-img-cover parent">
              <div className="sample-page-cont second-sample ">
                <div className="sample-page-right second-sample-page  ">
                  <h2>{data.Marathwada_heading2}</h2>
                </div>
                <div className="sample-page-left bg-img-contain"></div>
              </div>
            </div>
              ...
              <div className="container">
                ...
                >
                  <SwiperSlide>
                    <Tilt>
                      {" "}
                      <div className="slider1  bg-img-cover"></div>
                    </Tilt>
                  </SwiperSlide>
                  <SwiperSlide>
                    <Tilt>
